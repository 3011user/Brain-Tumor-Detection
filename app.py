...
def results():
    ...
    model = YOLO('C:\\Users\\yalin\\Downloads\\brain-tumor_b\\brain-tumor\\brain-tumor\\best.pt')
    ...
    for result in results:
        ...
        if len(boxes) > 0:
            ...
            tw = tumor_width_mm / 10
            th = tumor_height_mm / 10
    ...
    size = str(th) + ' x ' + str(tw)
    # In a real app, this would pass the results data to the template
    return render_template('results.html',size=size,type=tumor_type)
